...
# Spring Boot JdbcTemplate example: Build CRUD App
...
> [Spring Boot JdbcTemplate CRUD example](https://www.bezkoder.com/spring-boot-jdbctemplate-crud-example/)

> [Spring Boot & Spring JPA: CRUD example](https://www.bezkoder.com/spring-boot-jpa-h2-example/)
